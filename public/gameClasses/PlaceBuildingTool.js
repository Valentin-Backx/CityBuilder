...
PlaceBuildingTool.prototype.clicCall = function(tileX,tileY,event) {
	...
	if(this.isSpotValid(tileX,tileY)&&ige.client.gameManager.canAffordBuilding(this.currentBuilding))
	{
		this.currentBuilding
			...
			.bounds3d(
				this.currentBuilding.size.w * ige.client.tileMap.tileWidth(),
				this.currentBuilding.size.h * ige.client.tileMap.tileHeight(),
				this.currentBuilding.altitude
			)
			.draw()
			.place(tileX,tileY);
